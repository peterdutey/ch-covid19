...
att_fractions <- 0
for(i in 1:5) {
  residents_episodes_short_counterfact <- mutate(
    residents_episodes_short, 
    # date2 = if_else(death_status == 1 & covid_status_outbreak_digit == as.character(i), 105, date2),
    # death_status = if_else(death_status == 1 & 
    #                          covid_status_outbreak_digit == as.character(i),
    #                        0L, death_status),
  ...
  death_predictions_counterfactual <- 1 - predict(cph_death3, 
                                                  residents_episodes_short_counterfact, 
                                                  type = "survival")
