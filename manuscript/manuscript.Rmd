...
Peter Dutey Magni,^{1} Haydn Williams,^{2} Arnoupe Jhass,^{1} Greta Rait, Harry Hemingway,^{134} Andrew Hayward,^{1} Laura Shallcross^{1}


1 Institute of Health Informatics, University College London, London, UK
2 Four Seasons Health Care Group
3 Health Data Research UK, University College London, London, UK
4 University College London Hospitals NIHR Biomedical Research Centre, London, UK
5 Institute of Epidemiology & Health Care, University College London, London, UK
...
Data were analysed in `R`3·5·0 using the `epitool`[@Aragon2020] and `survival`[@therneau2015] libraries. All computer syntax is available on an online repository.[@Dutey2020] Ninety-five percent confidence intervals for proportions and rates were computed from the exact Poisson and binomial limits.
...
Higher staff to resident ratios were associated with lower risk of infection: care homes with less than 1 staff per bed had a risk of infection four times higher than those with >=1.4 staff per bed, once adjusting for other factors.


`r table_nums("tab_CoxPH_confirmed")`

```{r hazard_ratios_confirmed,   results="asis"}
# cph_conf <- coxph(Surv(time = start_int, time2 = stop_int +1, event = confirmed) ~ gender + ageg+home_type+user_type2+  staff_to_bed_ratio_g5+bed_tot_category  +occ_bedroom_ratio_g6, data = residents_overview)
#  summary(cph_conf)
# cox.zph(cph_conf)
...
explanatory = c("gender", "ageg", "home_type", "user_type2",  
                "bed_tot_category", "staff_to_bed_ratio_g5",  "occ_bedroom_ratio_g6")
