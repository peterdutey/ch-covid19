...
arsenal::tableby(
  confirmed  ~ gender + ageg  +  home_type + user_type2  + staff_to_bed_ratio_g5 +  occ_bedroom_ratio_g6, 
...
arsenal::tableby(
  death_status  ~ gender + ageg  +  home_type + user_type2  + staff_to_bed_ratio_g5 +  occ_bedroom_ratio_g6, 
  control = arsenal::tableby.control(test = FALSE, cat.stats = "countrowpct", digits = 1L),
  data = residents_overview) %>%  summary()
