...
Model-based estimates indicate that 653/1,694 (39%) all-cause deaths were attributable to COVID-19 (Table S7). In care homes with outbreaks only, just 161/1014 (16%) deaths attributable to COVID-19 occurred in people with confirmed infection (Groups C and D).
